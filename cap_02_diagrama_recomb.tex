  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[local bounding box=fig1]
      ...
      \begin{scope}[start chain=1 going right,node distance=-0.15mm, shift={(0,-2*\verticalmargin)}]
        ...
        \node [left=of parent_2_left] {$P_2$};
      \end{scope}
      \begin{scope}[start chain=1 going right,node distance=-0.15mm, shift={(0,-3*\verticalmargin)}]
        \node [on chain=1,gene, draw=red, very thick] (mutation_left) {1};
        \node [on chain=1,gene]                                       {0};
        \node [on chain=1,gene]                                       {0};
        \node [on chain=1,gene]                                       {0};
        \node [on chain=1,gene]                                       {0};
    ...
    \end{scope}
    \begin{scope}[xshift=20.4em, local bounding box=fig2]
      \begin{scope}[start chain=1 going right,node distance=-0.15mm]
        \node [on chain=1,gene, draw=red, very thick] (mut_offspring_1_left)  {1};
        \node [on chain=1,gene]                                               {0};
        \node [on chain=1,gene]                                               {1};
        \node [on chain=1,gene]                                               {1};
        \node [on chain=1,gene]                                               {1};
      ...
      \end{scope}
      \begin{scope}[start chain=1 going right,node distance=-0.15mm, shift={(0,-3*\verticalmargin)}]
        \node [on chain=1,gene_filled, draw=red, very thick] (mut_offspring_2_left)  {0};
        \node [on chain=1,gene_filled]                                               {1};
        \node [on chain=1,gene_filled]                                               {1};
        \node [on chain=1,gene_filled]                                               {0};
        \node [on chain=1,gene_filled]                                               {1};
      ...
      \end{scope}
      \path [font=\tiny] (mask_right.east)++(0.15,0) edge node [above] {$(P_1 \land R ) \lor (P_2 \land \lnot R)$} (offspring_1_left.west);
      \path [font=\tiny] (parent_2_right.east)++(0.15,0) edge node [below] {$(P_1 \land \lnot R ) \lor (P_2 \land R)$} (offspring_2_left.west);
